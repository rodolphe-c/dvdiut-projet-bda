...
import dvdiut.controlleurs.ControlleurEcranRechercherActeur;
...
public class EcranRechercherActeur extends JFrame implements ActionListener, ListSelectionListener, NavigationMenu, ActionChoixFilm, ActionRecherche{
	...
	private ControlleurEcranRechercherActeur controlleur;
	...
	public EcranRechercherActeur(Connection co) 
	{
		this.co = co;
		controlleur = new ControlleurEcranRechercherActeur();
		...
		JLabel lblRechercherUnFilm = new JLabel("Rechercher un film par acteur");
		...
		JLabel lblNomActeur = new JLabel("Nom :");
		pnlNom.add(lblNomActeur);
		...
		JLabel lblPrenomActeur = new JLabel("Prénom :");
		pnlPrenom.add(lblPrenomActeur);
	...
	public void validerSaisie()
	{
		...
		{
			listModel = initFilm(co, tfdNom.getText(), tfdPrenom.getText());
	 ...
	 */
	private DefaultListModel<Film> initFilm(Connection co, String nom, String prenom) 
	{
		return controlleur.initFilm(co, nom, prenom);
	}
